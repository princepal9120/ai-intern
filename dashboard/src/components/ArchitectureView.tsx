  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-y-auto bg-black text-[#e6edf3] p-4 lg:p-8">
      <div className="max-w-5xl mx-auto w-full flex flex-col gap-6">
        ...
        <div className="border border-neutral-800 rounded-xl bg-[#090b0e] p-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 font-mono text-xs">
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="w-full md:w-56 bg-black border border-neutral-800 p-3 rounded-lg shrink-0">
              ...
              <div className="flex-1 bg-black/60 border border-neutral-800/80 p-3 rounded-lg text-[#8b98a9] text-[11px]">Validates Access token or HMAC webhook signatures.</div>
            </div>
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="w-full md:w-56 bg-black border border-neutral-800 p-3 rounded-lg shrink-0">
              ...
              <div className="hidden md:flex text-teal-500 font-bold px-1">→</div>
              <div className="flex-1 bg-black/60 border border-neutral-800/80 p-3 rounded-lg text-[#8b98a9] text-[11px]">Routes agent commands and proxies container preview ports.</div>
            </div>
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="w-full md:w-56 bg-black border border-neutral-800 p-3 rounded-lg shrink-0">
              ...
              <div className="hidden md:flex text-teal-500 font-bold px-1">→</div>
              <div className="flex-1 bg-black/60 border border-neutral-800/80 p-3 rounded-lg text-[#8b98a9] text-[11px]">Plans steps using Llama 3.1 8B and manages human approval gates.</div>
            </div>
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="w-full md:w-56 bg-black border border-teal-500/40 p-3 rounded-lg shrink-0">
              ...
              <div className="hidden md:flex text-teal-500 font-bold px-1">→</div>
              <div className="flex-1 bg-black/60 border border-neutral-800/80 p-3 rounded-lg text-[#8b98a9] text-[11px]">Isolated micro-container running git, test suites, and edits.</div>
            </div>
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="w-full md:w-56 bg-black border border-neutral-800 p-3 rounded-lg shrink-0">
              ...
              <div className="hidden md:flex text-teal-500 font-bold px-1">→</div>
              <div className="flex-1 bg-black/60 border border-neutral-800/80 p-3 rounded-lg text-[#8b98a9] text-[11px]">Dummy credentials swapped with real keys safely on Worker wire.</div>
            </div>
          </div>
        </div>
      </div>
